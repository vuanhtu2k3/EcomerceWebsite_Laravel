                ...
                <div class="col-md-7">
                    <div class="bg-light right">
                        ...
                        @if ($product->compare_price > 0)
                            <h2 class="price text-secondary"><del>{{ $product->compare_price }} VND</del></h2>
                        @endif
                            ...
                            <div class="card product-card">
                                ...
                                <div class="card-body text-center mt-3">
                                    ...
                                    <div class="price mt-2">
                                        <span class="h5"><strong>{{ $relProduct->price }} VND</strong></span>
                                        @if ($relProduct->compare_price > 0)
                                            <span class="h6 text-underline"><del>{{ $relProduct->compare_price }}
                                                    VND</del></span>
                                        @endif
                                    </div>
                                </div>
